...
- **A more specific composite matches** (hotfix, incident-response, release-cut, merge-confidently): defer to it. This skill is the default for build/add/fix/implement, not a universal override.
...
- Phase 3: Phased implementation plan written to `docs/specs/<date>-<slug>/tasks.md`.

...
- [references/setup-and-configuration.md](./references/setup-and-configuration.md) — Project initialization and config
- [references/component-patterns.md](./references/component-patterns.md) — Component composition and patterns
- [references/nextjs-integration.md](./references/nextjs-integration.md) — Next.js App/Pages Router integration
- [references/advanced-patterns.md](./references/advanced-patterns.md) — Advanced composition and edge cases
- [references/examples.md](./references/examples.md) — Copy-paste examples
- [references/chart.md](./references/chart.md) — Chart components and setup
- [references/official-ui-reference.md](./references/official-ui-reference.md) — Full component catalog and API

---
name: impeccable
description: Design and improve frontend interfaces with UX review, accessibility, theming, and design systems. Covers landing pages, dashboards, apps, components, forms, and onboarding. Handles typography, spacing, layout, color, motion, and empty states. Use for UI polish and component design. Not for backend-only or experimental art-direction work.
version: 3.1.0
user-invocable: true

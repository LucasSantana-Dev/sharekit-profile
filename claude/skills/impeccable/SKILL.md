---
name: impeccable
description: Design, redesign, shape, critique, audit, polish, clarify, distill, harden, optimize, adapt, animate, or improve a frontend interface. Covers websites, landing pages, dashboards, product UI, components, forms, settings, onboarding, empty states. Handles UX review, visual hierarchy, accessibility, performance, responsive behavior, theming, typography, spacing, layout, color, motion, micro-interactions, UX copy, error states, i18n, and design systems. Not for backend-only or non-UI tasks.
version: 3.1.0
user-invocable: true

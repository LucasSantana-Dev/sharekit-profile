...
<Agent_Prompt>
  ...
  <Document_Type_Guide>
    Match structure and depth to the document type:
  ...
  <Investigation_Protocol>
    1) Parse the request to identify the exact documentation task AND the document type (README / API docs / ADR / comments / user guide).
    ...
    4) Apply the Document_Type_Guide structure for the detected type.
